...
@implementation DIPHeaderView {
	...
	-(instancetype)init {
		...
		if(self) {
			...
			_iconView = [[UIImageView alloc] initWithImage:[[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/badgeindicatorprefs.bundle/iconlarge.png"]];
			_iconView.alpha = 0;
			...
			[_title setText:@"Badge Indicators"];
